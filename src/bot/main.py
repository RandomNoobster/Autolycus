...
from src.utils.discord.config.counters import *

@bot.tree.command(name="counters", description="Manage counters")
async def counters(interaction: discord.Interaction):
    await interaction.response.send_message("Select an option...", view=DropdownView())
